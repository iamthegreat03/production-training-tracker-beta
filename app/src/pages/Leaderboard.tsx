    ...
    >
      ...
      <div className="relative overflow-hidden shrink-0" style={{ height: meta.heroH }}>
        ...
        <img
          ...
          className="absolute bottom-0 left-1/2 -translate-x-[10%] h-[95%] object-contain object-bottom"
      ...
      <div
        ...
        style={{ background: 'rgba(0,0,0,1)', paddingTop: '1.75rem', paddingLeft: '1.75rem', paddingRight: '1.75rem', paddingBottom: '1.75rem' }}
